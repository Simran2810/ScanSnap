...
$.getJSON(chrome.extension.getURL('config/config.json'))
	.done(function (appConfig) {
		...
		function loadFiles(tabId) {
			var files = ["styles/material.min.css", "styles/cs.css", "scripts/jquery.min.js", "scripts/material.min.js", "scripts/overlay.js", "scripts/cs.js","scripts/file.js"];
...
//                         speaking = false;
//                         chrome.browserAction.setIcon({
//                             path: '19': 'images/icon-19_disabled.png',
// 			                       '38': 'images/icon-38_disabled.png'
//                         });
//                     }
//                 }
