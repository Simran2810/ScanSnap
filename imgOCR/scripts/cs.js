				...
				.done(function (text, overlayInfo) {
					...
					$.ajax({
						...
						error: function (x, t) {
							...
							$process.reject({
								type: 'translate',
								stat: t === 'timeout' ? 'Translation request timed out' : 'Here is the result',
	...
	var OCRTranslator = {
		...
		bindEvents: function () {
			...
			$body
				...
				.on('click', '.ocrext-ocr-ts', onTextToSpeech)
